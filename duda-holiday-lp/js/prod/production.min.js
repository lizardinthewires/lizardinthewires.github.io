...
d.S(a).hasClass("expanded")||(c.scrollTop()>e?d.S(a).hasClass("fixed")||(d.S(a).addClass("fixed"),d.S("body").addClass("f-topbar-fixed")):c.scrollTop()<=e&&d.S(a).hasClass("fixed")&&(d.S(a).removeClass("fixed"),d.S("body").removeClass("f-topbar-fixed")))}},off:function(){this.S(this.scope).off(".fndtn.topbar"),this.S(b).off(".fndtn.topbar")},reflow:function(){}}}(jQuery,window,window.document),function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;$(document).foundation(),b=75,s=$(window).height(),e=s-2*b+4,d=$("#content"),l=$("#container"),n=$("nav.arrows .arrow"),g=$(".desktop-button, .tablet-button, .mobile-button"),q=$(".site"),r=$(".site-wrap"),f=$("#bottom .columns"),o=$(".left-menu-trigger, .right-menu-trigger"),q=$(".site"),j=$(".greeting"),k=$(".greeting").find("svg"),p=function(){var a,c;return c=$(window).height()-2*b+4,a=$(".right-menu-trigger").position().top-150,$(".site, #content").height(c),$("nav.arrows").css({"padding-top":a+"px"})},window.onresize=function(){var a;return clearTimeout(a),a=setTimeout(function(){return function(){return p()}}(this),300)},d.css({height:e}),$(".site").css({height:e}),a=$(".right-menu-trigger").position().top-150,$("nav.arrows").css({"padding-top":a+"px"}),$(".left-menu-trigger").on("click",function(){return l.toggleClass("menu-open-left")}),$(".right-menu-trigger").on("click",function(){return l.toggleClass("menu-open-right")}),$("span.close").on("click",function(){return l.toggleClass($(this).parent().parent().hasClass("left")?"menu-open-left":"menu-open-right")}),m=function(){var a,b,c,d;if(d=$(this).parents(".menu").find("ul").parent(),a=d.find("li:not(.hide)"),c=a.length-1,b=a.height(),215>=b&&(b+=15),$(this).hasClass("up")){if(!(d.position().top>=230))return d.filter(":not(:animated)").animate({top:"+="+b})}else if($(this).hasClass("down")&&!(d.position().top<=230-c*b))return d.filter(":not(:animated)").animate({top:"-="+b})},$(".menu.left").find(n).on("click",m),$(".menu.right").find(n).on("click",m),h=function(){return g.removeClass("active"),q.removeClass("desktop tablet mobile"),r.removeClass("desktop tablet mobile small"),r.css({display:"none"}),$(this).addClass("active"),$(this).hasClass("desktop-button")?(q.addClass("desktop"),r.addClass("desktop")):$(this).hasClass("tablet-button")?(q.addClass("tablet"),r.addClass("tablet"),550>e&&r.addClass("small")):$(this).hasClass("mobile-button")&&(q.addClass("mobile"),r.addClass("mobile"),550>e&&r.addClass("small")),r.delay(500).fadeIn("slow")},g.on("click",h),i=function(){if(j.length>=1)if($(".overlay").fadeOut(100).remove(),j.fadeOut(100).remove(),f.fadeIn(1500),$(this).hasClass("tablet-button")?(q.addClass("tablet"),$(".tablet-button").addClass("active")):$(this).hasClass("mobile-button")?(q.addClass("mobile"),$(".mobile-button").addClass("active")):(q.addClass("desktop"),$(".desktop-button").addClass("active")),$(this).hasClass("right-menu-trigger"));else if(!$(this).hasClass("left-menu-trigger"))return l.toggleClass("menu-open-left")},g.on("click",i),k.on("click",i),o.on("click",i),c=$(location).attr("hash"),"#gifts"===c&&(j.hide(),$(".overlay").hide(),$(l).delay(1e3).queue(function(){return $(this).toggleClass("menu-open-right")}),$(".show-for-medium-down .temps").hide(),$(".show-for-medium-down .gifts").show()),$(".templates li > button").on("click",function(){var a,b,c,d,e,f;switch(q.css({display:"none"}),d=$(".hero"),c=$(".generic"),a=$(".about"),b=$(".coupon"),e="thanksgiving black-friday small-biz-saturday cyber-monday x-mas",f=$(this).data("template"),a.removeClass(e),b.removeClass(e),c.css({"background-attachment":"scroll","background-position":"initial"}),$("#container").removeClass("menu-open-left"),q.delay(500).fadeIn("slow"),q.animate({scrollTop:0},"slow"),f){case"thanksgiving":return d.attr("src","/duda-holiday-lp/img/templates/thanksgiving/hero.png"),c.css({"background-image":"url(/duda-holiday-lp/img/templates/thanksgiving/main.jpg)"}),a.addClass("thanksgiving"),b.addClass("thanksgiving").find("img").attr("src","/duda-holiday-lp/img/templates/thanksgiving/coupon.jpg"),b.removeClass("hide"),b.find(".top").text("25% OFF"),b.find(".middle").text("Turkey Day Treat");case"black-friday":return d.attr("src","/duda-holiday-lp/img/templates/black-friday/hero.png"),c.css({"background-image":"url(/duda-holiday-lp/img/templates/black-friday/main.png)"}),a.addClass("black-friday"),b.addClass("black-friday").find("img").attr("src","/duda-holiday-lp/img/templates/black-friday/coupon.jpg"),b.removeClass("hide"),b.find(".top").text("$20 OFF"),b.find(".middle").text("One-Day Sale!");case"small-biz-saturday":return d.attr("src","/duda-holiday-lp/img/templates/small-biz-sat/hero.png"),c.css({"background-image":"url(/duda-holiday-lp/img/templates/small-biz-sat/main.jpg)"}),a.addClass("small-biz-saturday"),b.addClass("small-biz-saturday").find("img").attr("src","/duda-holiday-lp/img/templates/small-biz-sat/coupon.jpg"),b.removeClass("hide"),b.find(".top").text("$20 OFF"),b.find(".middle").text("Saturday Special!"),b.find("img").parent().addClass("right");case"cyber-monday":return d.attr("src","/duda-holiday-lp/img/templates/cyber-monday/hero.png"),c.css({"background-image":"url(/duda-holiday-lp/img/templates/cyber-monday/main.png)"}),a.addClass("cyber-monday"),b.addClass("cyber-monday").find("img").attr("src","/duda-holiday-lp/img/templates/cyber-monday/coupon.jpg"),b.removeClass("hide"),b.find(".top").text("$20 OFF"),b.find(".middle").text("DIGITAL DEAL"),b.find("img").parent().addClass("right");case"christmas":return d.attr("src","/duda-holiday-lp/img/templates/x-mas/hero.png"),c.css({"background-image":"url(/duda-holiday-lp/img/templates/x-mas/main.png)"}),a.addClass("x-mas"),b.addClass("x-mas").find("img").attr("src","/duda-holiday-lp/img/templates/x-mas/coupon.jpg"),b.removeClass("hide"),b.find(".top").text("$5 OFF"),b.find(".middle").text("Our Gift To You");default:return